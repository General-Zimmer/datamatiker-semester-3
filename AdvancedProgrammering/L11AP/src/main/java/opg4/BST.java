...
//
    ...
    private class Iteratorererereerr implements Iterator<E> {

        Stack<TreeNode<E>> stack = new Stack<>();

        public Iteratorererereerr() {
            populateStack(root);
        }
        ...
        private void populateStack(TreeNode<E> node) {
            if (node == null) {
                return;
            }
